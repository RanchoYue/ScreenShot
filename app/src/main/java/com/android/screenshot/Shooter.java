...
public class Shooter {
    ...
    public Shooter(Context context, int reqCode, Intent data) {
        ...
        mImageReader = ImageReader.newInstance(mWidth, mHeight, PixelFormat.RGBA_8888,//this is necessary to equal buffer format in #copyPixelsFromBuffer.
                1);
    }
    ...
    public class SaveTask extends AsyncTask<Image, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Image... params) {
            ...
            Bitmap bitmap = Bitmap.createBitmap(width + rowPadding / pixelStride, height, Bitmap.Config.ARGB_8888);//even though ARGB8888 will consume more memory,it has better compatibility on device.
